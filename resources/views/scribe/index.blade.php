    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-todos">GET api/todos</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-todos">
                                <a href="#endpoints-POSTapi-todos">POST api/todos</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-todos--id-">
                                <a href="#endpoints-GETapi-todos--id-">GET api/todos/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-todos--id-">
                                <a href="#endpoints-PUTapi-todos--id-">PUT api/todos/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-todos--id-">
                                <a href="#endpoints-DELETEapi-todos--id-">DELETE api/todos/{id}</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-todos">GET api/todos</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-todos">POST api/todos</h2>
...
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
                    ...
                    <h2 id="endpoints-GETapi-todos--id-">GET api/todos/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/todos/4" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the todo. Example: <code>4</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-PUTapi-todos--id-">PUT api/todos/{id}</h2>
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-todos--id-">DELETE api/todos/{id}</h2>
